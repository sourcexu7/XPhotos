...
const INITIAL_CONFIGS = [
  ...
  { config_key: 'cos_endpoint', config_value: '', detail: '腾讯云 COS Endpoint（S3兼容），如：https://cos.ap-guangzhou.myqcloud.com' },
  { config_key: 'cos_bucket', config_value: '', detail: '腾讯云 COS Bucket（通常含 AppId 后缀），如：example-1250000000' },
  { config_key: 'cos_storage_folder', config_value: '', detail: '存储文件夹(COS)，严格格式，如：xphotos 或 xphotos/images ，填 / 或者不填表示根路径' },
  { config_key: 'cos_force_path_style', config_value: 'false', detail: '是否强制客户端对桶使用路径式寻址，默认 false。' },
  { config_key: 'cos_cdn', config_value: 'false', detail: '是否启用 COS CDN 模式，路径将返回 cdn 地址，默认 false。' },
  { config_key: 'cos_cdn_url', config_value: '', detail: 'COS cdn 地址，如：https://cdn.example.com' },
  { config_key: 'cos_direct_download', config_value: 'false', detail: '是否启用 COS 直接下载模式，默认 false。' },
