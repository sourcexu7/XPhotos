  ...
  return (
    <motion.div 
      ...
      style={{
        ...
        borderImage: isHovered ? 'linear-gradient(to right, var(--primary), var(--secondary)) 1' : 'none',
      }}
      className="group"
    ...
    >
      ...
      <div 
        ...
        style={{
          padding: '1px',
          background: isHovered ? 'linear-gradient(to right, var(--primary), var(--secondary))' : 'transparent',
