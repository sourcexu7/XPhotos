...
export function ModernDashboard({
  ...
  const getStatIcon = (id: string) => {
    switch (id) {
      case 'total':
        return <GalleryThumbnails className="text-blue-500" />
      case 'public':
        return <Eye className="text-green-500" />
      case 'albums':
        return <LayoutGrid className="text-purple-500" />
      case 'cameras':
        return <Camera className="text-orange-500" />
      default:
        return null
    }
  }
          ...
          {stats.map((s) => {
            ...
            return (
              <button
                ...
                className="group relative overflow-hidden rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 text-left transition-all hover:shadow-md hover:border-slate-300 dark:hover:border-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/30"
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="rounded-lg bg-slate-50 dark:bg-slate-800 p-2 group-hover:bg-blue-50 dark:group-hover:bg-blue-900/20 transition-colors">
                    {icon}
                  </div>
                </div>
