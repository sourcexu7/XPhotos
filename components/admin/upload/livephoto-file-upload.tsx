  ...
  return (
    <div className="admin-upload flex flex-col space-y-2 h-full flex-1 font-sans text-sm">
          ...
          <div className="flex flex-col" style={{ minWidth: 240 }}>
            ...
            <div>
              <MultipleSelector
                ...
                placeholder={t('Upload.secondaryTagPlaceholderMultiple')}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch">
          ...
          <AntCard className="h-full" title={t('Upload.uploadFilesCardTitle')}>
            <AntSpace vertical size="middle" style={{ width: '100%' }}>
              ...
              >
                <div className="flex flex-col items-center justify-center h-full gap-2">
                  <UploadIcon />
                  <p className="font-medium text-sm">{t('Upload.dragOrClickVideo')}</p>
                  <p className="text-muted-foreground text-xs">{t('Upload.uploadTipsSingle')}</p>
                  {(storage === '' || album === '' || (storage === 'alist' && alistMountPath === '')) && (
                    <p className="text-[12px]" style={{ color: '#999' }}>
                      {t(storage === 'alist' ? 'Tips.selectStorageAndAlbumWithAListDirectory' : 'Tips.selectStorageAndAlbum')}
        ...
        <div className="h-full">
          <AntCard className="h-full" title={t('Upload.metadataCardTitle')}>
            <AntSpace vertical size="middle" style={{ width: '100%' }}>
              <div className="text-xs font-medium" style={{ color: '#666' }}>{t('Upload.addressAndSizeHeading')}</div>
              <div>
              ...
              <div>
                ...
                {!url && (
                  <div className="text-[12px] mt-1" style={{ color: '#cf1322' }}>{t('Upload.originNotUploadedHint')}</div>
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  {!width && (
                    <div className="text-[12px] mt-1" style={{ color: '#cf1322' }}>{t('Tips.imageWidthRequired')}</div>
                  )}
                </div>
                <div>
                  ...
                  {!height && (
                    <div className="text-[12px] mt-1" style={{ color: '#cf1322' }}>{t('Tips.imageHeightRequired')}</div>
                  )}
                </div>
              </div>

              <div className="text-xs font-medium" style={{ color: '#666' }}>{t('Upload.detail')}</div>
            ...
            <div>
            <div className="text-sm font-medium mb-1">{t('Upload.presetTagsClickAddRemoveHint')}</div>
              ...
              {/* EXIF quick-fill */}
              <div>
                <div className="text-sm font-medium mb-1">{t('Upload.exifInfoMissingHint')}</div>
      ...
      {(!exif || Object.keys(exif).length === 0) && (
        <div className="mt-3 p-3 border rounded">
          <div className="text-sm font-medium mb-2">{t('Upload.manualFillExifNotDetectedHint')}</div>
