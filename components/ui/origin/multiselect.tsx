  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            'relative min-h-[38px] rounded-lg border border-[#e6e6e6] text-sm transition-shadow focus-within:border-[#4299e1] focus-within:outline-none focus-within:shadow-[inset_0_0_0_1px_rgba(66,153,225,0.12)] has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-50',
            {
            ...
            {selected.map((option) => {
              return (
                <div
                  key={option.value}
                  className={cn(
                    'animate-fadeIn relative inline-flex h-7 cursor-default items-center rounded-md border border-solid bg-muted pe-7 pl-2 ps-2 text-xs font-medium text-foreground transition-all hover:bg-muted/80 disabled:cursor-not-allowed disabled:opacity-50 data-[fixed]:pe-2',
                    badgeClassName,
                  )}
