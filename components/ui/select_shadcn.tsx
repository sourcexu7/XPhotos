...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between gap-2 rounded bg-white border border-[#e5e5e5] hover:border-[#409eff] px-3 py-2 text-start text-sm text-[#333333] leading-[24px] cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 data-[placeholder]:text-muted-foreground/70 [&>span]:min-w-0 shadow-inner shadow-black/5",
      className,
    )}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-pointer items-center rounded py-2 px-3 text-sm text-[#333333] leading-[24px] select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 hover:bg-[#f8f8f8] data-[state=checked]:bg-[#ecf5ff]',
      className,
    )}
    {...props}
  >
