...
async function getData(pageNum: number, Album: string, showStatus = -1, featured = -1, camera = '', lens = '', exposure = '', f_number = '', iso = '', labels: string[] = [], labelsOperator: 'and' | 'or' = 'and') {
  'use server'
...
async function getTotal(Album: string, showStatus = -1, featured = -1, camera = '', lens = '', exposure = '', f_number = '', iso = '', labels: string[] = [], labelsOperator: 'and' | 'or' = 'and') {
  'use server'
