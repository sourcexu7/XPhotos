        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-20">
          ...
          <section className="w-full lg:w-[30%] flex flex-col justify-center space-y-6 order-2 lg:order-1">
            ...
            <header className="space-y-4">
              ...
              {intro && (
                <p className="text-sm md:text-base lg:text-lg text-muted-foreground leading-relaxed max-w-md whitespace-pre-line">
                  {intro}
                </p>
              )}
            </header>
            ...
            {galleryImages.length > 0 ? (
              ...
              >
                <div className="text-center space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">尚未配置个人照片</p>
                </div>
              </div>
            )}
          </section>
